...
private:
    void createAttatch(QOpenGLTexture *&texture);
    void renderCube();
    void renderQuad();

private:
    unsigned int m_fBufO = 0;
    unsigned int m_fBoolmBufs[2]{0};
    QOpenGLShaderProgram m_pShaderProgram;
    QOpenGLShaderProgram m_pBloomShaderProgram;
    QOpenGLShaderProgram m_pFrameBufShaderProgram;
    QOpenGLTexture *m_woodTexture = nullptr;
    QOpenGLTexture *m_boardTexture = nullptr;
    QOpenGLTexture *m_fHdrTexture = nullptr;
    QOpenGLTexture *m_hightLightTexture = nullptr;
    QOpenGLTexture *m_bloomHTexture = nullptr;
    QOpenGLTexture *m_bloomVTexture = nullptr;
